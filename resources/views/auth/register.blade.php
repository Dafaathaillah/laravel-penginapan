                ...
                <div class="col-sm-12">
                    <form class="md-float-material form-material" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('log/images/png/logo.png') }}" alt="logo.png">
                        </div>
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    <input type="text"
                                        ...
                                        name="username" value="{{ old('username') }}" r equired autocomplete="username">
                                    <span class="form-bar"></span>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <p class="text-inverse text-left"><a href="{{ route('login') }}"><b>Login</b></a>
                                        </p>
                                    </div>
                                    <div class="col-md-2">
                                        <img src="{{ asset('log/images/png/logo-small-bottom.png') }}" alt="small-logo.png">
                                    </div>
                                </div>
                            </div>
                        </div>
